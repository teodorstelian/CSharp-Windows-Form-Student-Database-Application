...
namespace FlaUiTests
{
    ...
    public class StudentHelperTests
    {
        ...
        public void T03_Launch_Register_Login_Quit()
        {
            ...
            /// Enter data into fields
            _loginWindow.FindFirstDescendant(cf.ByAutomationId("emailLogin")).AsTextBox().Enter("Email@yahoo.com");
            _loginWindow.FindFirstDescendant(cf.ByAutomationId("passwordLogin")).AsTextBox().Enter("Pwd");
